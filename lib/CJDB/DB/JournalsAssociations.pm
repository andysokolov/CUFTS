...
package CJDB::DB::JournalsAssociations;
...
__PACKAGE__->sequence('cjdb_journals_associations_id_seq');

__PACKAGE__->has_a( 'journal'     => 'CJDB::DB::Journals' );
__PACKAGE__->has_a( 'association' => 'CJDB::DB::Associations' );
