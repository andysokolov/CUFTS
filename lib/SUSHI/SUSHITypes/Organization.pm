package SUSHI::SUSHITypes::Organization;
use strict;
use warnings;
...
SUSHI::SUSHITypes::Organization

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Organization from the namespace http://www.niso.org/schemas/counter.
...
Constructor. The following data structure may be passed to new():
 ...
 { # SUSHI::SUSHITypes::Organization
   ...
   WebSiteUrl =>  $some_value, # anyURI
   LogoUrl =>  $some_value, # anyURI
 },
