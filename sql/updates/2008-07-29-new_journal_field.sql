...
ALTER TABLE journals ALTER COLUMN title TYPE VARCHAR(1024);
ALTER TABLE journals ADD COLUMN coverage VARCHAR(1024);
ALTER TABLE local_journals ALTER COLUMN title TYPE VARCHAR(1024);
ALTER TABLE local_journals ADD COLUMN coverage VARCHAR(1024);
