...
my $journal1 = $resource1->add_to_journals({
	title        => 'Journal Title First',
	issn         => '11112222',
});

my $journal2 = $resource1->add_to_journals({
	title        => 'Journal Title Second',
	issn         => '22223333',
	e_issn       => '33334444',
});

my $journal3 = $resource2->add_to_journals({
	title        => 'Journal Title First',
	issn         => '11112222',
});

my $journal4 = $resource1->add_to_journals({
...
my $journal5 = $resource1->add_to_journals({
	title        => 'Journal Should Fail',
	issn         => '22223333',
	e_issn       => '9119119X',
});

my $journal6 = $resource1->add_to_journals({
